...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrgParticipant', function() {
      beforeEach(function() {
        instance = new WolontariuszApi.OrgParticipant();
      });

      it('should create an instance of OrgParticipant', function() {
        // TODO: update the code to test OrgParticipant
        expect(instance).to.be.a(WolontariuszApi.OrgParticipant);
      });
